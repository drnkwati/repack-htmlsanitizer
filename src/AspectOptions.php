...
interface AspectOptions extends \ArrayAccess, \Countable
{
    /**
     ...
     * @return $this
     *
     * @throws InvalidArgumentException if an option has not been defined
     ...
     * @return $this
     *
     * @throws InvalidArgumentException if an option has not been defined for
     ...
     *
     * @throws InvalidArgumentException   if any of the passed options has not
     *                                   been defined or does not contain an
     *                                   allowed value
     * @throws InvalidArgumentException   if a required option is missing
     * @throws LogicException if a cyclic dependency is detected
